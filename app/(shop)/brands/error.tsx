...
type BrandsErrorProps = {
  error: Error & { digest?: string };
  retry: () => void;
};

export default function BrandsError({ retry }: BrandsErrorProps) {
  return (
    <PageContainer className="py-16 pb-[calc(var(--spacing-bottom-nav)+var(--spacing-16))] text-center md:py-24">
      <section aria-labelledby="brands-error-title" role="alert">
        <h1 className="text-heading-2 text-text-primary" id="brands-error-title">Unable to load brands</h1>
