...
type SubcategoriesErrorProps = {
  error: Error & { digest?: string };
  retry: () => void;
};

export default function SubcategoriesError({ retry }: SubcategoriesErrorProps) {
  return (
    <PageContainer className="py-16 pb-[calc(var(--spacing-bottom-nav)+var(--spacing-16))] text-center md:py-24">
      <section aria-labelledby="subcategories-error-title" role="alert">
        <h1 className="text-heading-2 text-text-primary" id="subcategories-error-title">Unable to load subcategories</h1>
